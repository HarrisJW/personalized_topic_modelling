...
class Oraclev3:
    def __init__(self, docs, labels, model, target_names=None):
        ...
        print("Printing oraclev3 class_words")
    ...
    def get_feedback(self, clusters):
        ...
        return self.get_bm25_docs_by_prob_word_given_topic_words(c)

    def get_bm25_docs_by_prob_word_given_topic_words(self, cluster_id):
        # ids = []
        ...
        #TODO: Use p(w|t) to create tokenized_query.Right now, this oracle is exaclty the same as oracle 2
        tokenized_query = self.class_words[cluster_id]
